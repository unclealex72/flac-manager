...
public class FixedID3v23Tag extends AbstractID3v2Tag {
    ...
    protected void copyPrimitives(AbstractID3v2Tag copyObj) {
        ...
        if (copyObj instanceof FixedID3v23Tag) {
            FixedID3v23Tag copyObject = (FixedID3v23Tag) copyObj;
     ...
     * @param copyObject
     */
    public FixedID3v23Tag(ID3v23Tag copyObject) {
     ...
     * @param mp3tag
     */
    public FixedID3v23Tag(AbstractTag mp3tag) {
     ...
     * @throws TagException
     */
    public FixedID3v23Tag(ByteBuffer buffer, String loggingFilename) throws TagException {
     ...
     * @param buffer
     * @throws TagException
     * @deprecated use {@link #FixedID3v23Tag(ByteBuffer, String)} instead
     */
    public FixedID3v23Tag(ByteBuffer buffer) throws TagException {
        this(buffer, "");
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof FixedID3v23Tag)) {
            return false;
        }
        FixedID3v23Tag object = (FixedID3v23Tag) obj;
        ...
        if (subFieldId != null) {
            for (TagField tagfield : list) {
                ...
                if (next instanceof FrameBodyTXXX) {
                    ...
                    // Fix by APJ: changed getUniqueIdentifier() to getOwner()
