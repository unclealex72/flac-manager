...
/**
  ...
  **/
class CalibrateCommandImpl @Inject() (calibrationService: CalibrationService) extends CalibrateCommand {
  /**
    ...
    * @return A [[Future]].
    */
  override def calibrate(maybeHighestConcurrencyLevel: Option[Int])
                        (implicit messageService: MessageService): Future[ValidatedNel[Message, Unit]] = {
    calibrationService.calibrate(maybeHighestConcurrencyLevel.getOrElse(Runtime.getRuntime.availableProcessors()))
  }
}
