 ...
 *
 */
public class MusicBrainzClientGetWithTwoCollectionsFailTest extends AbstractMusicBrainzClientGetTest {

  /**
   * @param rootResource
   */
  public MusicBrainzClientGetWithTwoCollectionsFailTest() {
