...
/**
 * A small utility class for finding a free port that can be used by embedded
 * web servers in test applications.
 * 
 * @author alex
 * 
 */
public final class FreePortFinder {
	...
	/**
	 * Instantiates a new free port finder.
	 */
