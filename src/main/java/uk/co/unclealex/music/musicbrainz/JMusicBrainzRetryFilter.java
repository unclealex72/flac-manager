 ...
 *
 */
public class JMusicBrainzRetryFilter extends ClientFilter {

  private static final Logger log = LoggerFactory.getLogger(JMusicBrainzRetryFilter.class);
  ...
  @Inject
  public JMusicBrainzRetryFilter(
