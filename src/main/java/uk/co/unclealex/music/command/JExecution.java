 ...
 * 
 */
public interface JExecution<C extends JCommandLine> {

  /**
   * Initialise this class.
   * @param commandLine The command line that was supplied by the user.
   * @return An {@link uk.co.unclealex.music.action.JActions} object that containing any errors found during initialisation.
   */
  public JActions initialise(JActions actions, C commandLine);
   ...
   * @return An {@link uk.co.unclealex.music.action.JActions} object containing all the actions that need to
   *         be executed.
   */
  public JActions execute(JActions actions, JFileLocation flacFileLocation, JMusicFile musicFile)
      throws IOException;
}
