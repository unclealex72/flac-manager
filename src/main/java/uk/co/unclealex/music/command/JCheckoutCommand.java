 ...
 * 
 */
public class JCheckoutCommand extends JCommand<JCheckoutCommandLine> {

  @Inject
  public JCheckoutCommand(
          JExecution<JCheckoutCommandLine> execution,
          JActions actions,
  ...
  @Override
  @Executable({ JCheckoutModule.class, JExternalModule.class, PackageCheckingModule.class })
  public void execute(JCheckoutCommandLine commandLine) throws IOException, JInvalidDirectoriesException {
