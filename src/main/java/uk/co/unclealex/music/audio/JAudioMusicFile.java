...
/**
 * An implementation of {@link uk.co.unclealex.music.JMusicFile} that gets and sets information from
 * and to an {@link AudioFile}.
 * 
 * @author alex
 * 
 */
public class JAudioMusicFile implements JMusicFile {
   ...
   */
  public JAudioMusicFile(Path audioFile) throws IOException {
    super();
    try {
  ...
  public JCoverArt getCoverArt() {
    ...
    return artwork == null ? null : new JCoverArt(artwork.getBinaryData(), artwork.getMimeType());
  }
   ...
   */
  @Override
  public void setCoverArt(JCoverArt coverArt) {
    if (coverArt == null) {
