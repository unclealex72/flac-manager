 ...
 * 
 */
public class JChangeOwnerAction extends JAbstractAction implements JAction {
   ...
   */
  public JChangeOwnerAction(JFileLocation fileLocation, JMusicFile musicFile, boolean addOwner, List<JUser> newOwners) {
    super(fileLocation);
   ...
   */
  public List<JUser> getNewOwners() {
    return newOwners;
  }

  /**
   * Gets the {@link uk.co.unclealex.music.JMusicFile} whose ownership is being changed.
   *
   * @return the {@link uk.co.unclealex.music.JMusicFile} whose ownership is being changed
   */
  public JMusicFile getMusicFile() {
    return musicFile;
  }
}
