 ...
 * 
 */
public class JMoveAction extends JAbstractAction implements JAction {

  /**
   * The location of where to move the file.
   */
  private final JFileLocation targetFileLocation;
   ...
   */
  public JMoveAction(JFileLocation fileLocation, JFileLocation targetFileLocation) {
    super(fileLocation);
   ...
   */
  public JFileLocation getTargetFileLocation() {
