 ...
 * 
 */
public class JFailureAction extends JAbstractAction implements JAction {
   ...
   */
  public JFailureAction(JFileLocation fileLocation, String messageTemplate, Object... parameters) {
    super(fileLocation);
