...
package uk.co.unclealex.music.exception;
 ...
 * 
 */
public class JInvalidDirectoriesException extends Exception {

  private final Iterable<Path> invalidDirectories;

  public JInvalidDirectoriesException(String message, Iterable<Path> invalidDirectories) {
    super(message);
