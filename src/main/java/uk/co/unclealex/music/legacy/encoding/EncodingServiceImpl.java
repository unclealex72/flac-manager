...
import uk.co.unclealex.music.legacy.ParentFilePredicate;
import uk.co.unclealex.music.legacy.inject.EncodedDirectory;
import uk.co.unclealex.music.legacy.inject.Encodings;
import uk.co.unclealex.music.legacy.inject.FlacDirectory;
import uk.co.unclealex.music.legacy.inject.MaximumThreads;
