...
import uk.co.unclealex.music.legacy.inject.AllDevices;
import uk.co.unclealex.music.legacy.inject.DevicesDirectory;
...
public class DeviceServiceImpl implements DeviceService {
	...
	protected class DeviceIsConnectedPredicate extends IpodAgnosticDeviceVisitor<Boolean> implements Predicate<Device> {
		...
		@Override
		public Boolean visit(AbstractFileSystemDevice fileSystemDevice) {
