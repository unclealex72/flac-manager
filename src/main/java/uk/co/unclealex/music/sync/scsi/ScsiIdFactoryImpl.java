...
/**
 * The default implementation of {@link ScsiIdFactory}.
 * 
 * @author alex
 * 
 */
public class ScsiIdFactoryImpl implements ScsiIdFactory {
   ...
   */
  @Override
  public ScsiId create(final int hba, final int channel, final int targetId, final int lun) {
    return new ScsiId(hba, channel, targetId, lun);
  }
   ...
   */
  @Override
  public ScsiId create(final String hctl) {
