 ...
 *
 */
public class JDeviceFile implements Comparable<JDeviceFile> {
   ...
   */
  public JDeviceFile(String id, String relativePath, long lastModified) {
    super();
    this.id = id;
	 ...
	 */
	@Override
	public int compareTo(JDeviceFile o) {
