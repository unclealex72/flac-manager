 ...
 *         &lt;element ref="{http://webservices.amazon.com/AWSECommerceService/2006-11-14}OperationInformation" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://webservices.amazon.com/AWSECommerceService/2006-11-14}ResponseGroupInformation" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Information {
    ...
    @XmlElement(name = "OperationInformation", required = true)
    protected List<OperationInformation> operationInformation;
    @XmlElement(name = "ResponseGroupInformation", required = true)
