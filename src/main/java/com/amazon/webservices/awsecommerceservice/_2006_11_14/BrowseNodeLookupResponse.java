 ...
 *         &lt;element ref="{http://webservices.amazon.com/AWSECommerceService/2006-11-14}BrowseNodes" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class BrowseNodeLookupResponse {
    ...
    @XmlElement(name = "BrowseNodes", required = true)
