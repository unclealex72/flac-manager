 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element ref="{http://webservices.amazon.com/AWSECommerceService/2006-11-14}SellerFeedback" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Seller {
    ...
    public static class SellerFeedbackSummary {
        ...
        @XmlElement(name = "FeedbackDateRange", required = true)
        ...
        public static class FeedbackDateRange {
            ...
            @XmlElement(name = "SellerFeedbackRating", required = true)
