 ...
 */
public class EscapingResourceFactoryImpl implements DavResourceFactory {

    private static Logger log =LoggerFactory.getLogger(EscapingResourceFactoryImpl.class);
     ...
     * @param lockMgr
     */
    public EscapingResourceFactoryImpl(LockManager lockMgr) {
     ...
     */
    public EscapingResourceFactoryImpl(LockManager lockMgr, ResourceConfig resourceConfig) {
        this.lockMgr = lockMgr;
    ...
    private Node getNode(DavSession sessionImpl, DavResourceLocator locator)
        ...
        try {
            ...
            if (repoPath != null) {
                ...
                repoPath = Jcr170Escaper.escape(repoPath);
                Item item = session.getItem(repoPath);
                if (item instanceof Node) {
                    node = new UnescapingNode((Node)item);
